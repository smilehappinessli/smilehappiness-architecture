 ...
 */
package cn.smilehappiness.distribute.service.impl;

import cn.smilehappiness.distribute.entity.BitsAllocator;
import cn.smilehappiness.distribute.exception.UidGenerateException;
import cn.smilehappiness.distribute.utils.DistributeDateUtils;
import cn.smilehappiness.distribute.service.UidGenerator;
import cn.smilehappiness.distribute.service.WorkerIdAssigner;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
     ...
     */
    protected String epochStr = "2021-10-01";
    protected long epochSeconds = TimeUnit.MILLISECONDS.toSeconds(1633017600000L);
    ...
    public String parseUID(long uid) {
        ...
        String thatTimeStr = DistributeDateUtils.formatByDateTimePattern(thatTime);
    ...
    public void setEpochStr(String epochStr) {
        if (StringUtils.isNotBlank(epochStr)) {
            ...
            this.epochSeconds = TimeUnit.MILLISECONDS.toSeconds(DistributeDateUtils.parseByDayPattern(epochStr).getTime());
        }
    }
}
