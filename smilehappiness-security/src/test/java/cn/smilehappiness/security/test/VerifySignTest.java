...
public class VerifySignTest {
    ...
    public void testVerifySign() {
        ...
        //check param
        /*request.setRequestSign("123456");
        request.setEncryptFlag(false);*/

        /*Map<String, Object> map = new HashMap<>(16);
        map.put("testParam", "hello");
        request.setBizContent(map);*/

        System.out.println("filter sign check params:" + JSON.toJSONString(request));
        ...
        client.signCheck(request, "");
        System.out.println("sign check pass");
    }
